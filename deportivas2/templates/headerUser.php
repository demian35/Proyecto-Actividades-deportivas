...
if (!isset($_SESSION["usuario"])) {
    ...
    unset($_SESSION["usuario"]); // Finalizar la sesión
    exit(); // Detener la ejecución del script después de la redirección


    // Verificar si la sesión está marcada como finalizada
if (isset($_SESSION['registroFinalizado']) && $_SESSION['registroFinalizado']) {
    // La sesión está marcada como finalizada, por lo que deshabilitamos el botón
    $botonDeshabilitado = true;
} else {
    // La sesión no está marcada como finalizada, por lo que el botón está habilitado
    $botonDeshabilitado = false;
}
}

// Si el usuario ha iniciado sesión, se puede continuar con el contenido de la página
?>
